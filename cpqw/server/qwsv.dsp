...
SOURCE="$(InputPath)"
PostBuild_Desc=Copying QWSV to Quake folder
PostBuild_Cmds=copy release\qwsv.exe c:\quake\cpqwsv.exe
...
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy debug\qwsv.exe c:\quake\cpqwsv.exe
# End Special Build Tool
