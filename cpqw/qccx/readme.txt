...
The following files are included in qccx100.zip:
...
*.qc, progs.src - bare-bones QuakeC project (5 .qc files and 1 progs.src)
progs.dat       - compiled progs.dat for bare-bones QuakeC project
