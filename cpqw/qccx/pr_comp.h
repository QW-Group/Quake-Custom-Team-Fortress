...
// OfN - Structure to pass to getdef for extra info, for determining stuff
typedef struct getdef_extras_s
{
	boolean allocation_done;
	boolean was_used;
} getdef_extras_t;
