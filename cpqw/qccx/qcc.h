...
typedef struct def_s
{
	...
	// OfN
	boolean is_used; // this flag holds wether this was used or not on code
	int source_line; // source code line where this was defined
	char* source_file; // file that defined this
	void* owned_by; // points to master float def_t that owns this vector
					// also points to itself if a builtin function (NULL if not)
} def_t;
...
void PR_RaiseWarning (int warningflags, char* sourcefile, int sourceline, char *warning, ...); // OfN
extern def_t* lastfunc;
extern boolean lastprecacheready;
...
#define MAX_STATEMENTS  524288 // OfN - Original was 65536
#define MAX_FUNCTIONS   32768 // OfN - Original was 8192
#define MAX_TEMPS		256

#define	MAX_SOUNDS		512 // OfN - Original was 1024
#define	MAX_MODELS		512 // OfN - Original was 1024
...
// OfN
extern int pr_warnings;

extern int numquakecwarnings;
extern int numunusedwarnings;
extern int numwarnings;

// Warning types BITWISE values
#define WARNINGTYPE_QUAKEC  1
#define WARNINGTYPE_UNUSED  2


struct precache_list
{
	int source_line;
	char* source_file;
	boolean is_used;
...
extern precache_list models_list[MAX_MODELS];
extern precache_list sounds_list[MAX_SOUNDS];
